...
for k in range(69, 70):
    ...
    if bool(re.search(r"top", save_dir)):
        ...
        # when bottom amplifier is used, data is found on metachannels
        # these correspond to channel_order_map: 40-43 and 48-51
        # either use channel_order_map for all or create separate workflow for bottom amp
        channels1, channels2 = [39, 40, 41, 42], [47, 48, 49, 50]
    else:
        channels1, channels2 = [], []
